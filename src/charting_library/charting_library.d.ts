...
export interface ChartingLibraryWidgetConstructor {
	new(options: { container: string; symbol: string; datafeed: any; fullscreen: boolean; interval: string; library_path: string; disabled_features: string[]; autosize: boolean }): IChartingLibraryWidget;
}
export interface ChartingLibraryWidgetOptions {
	/** @deprecated */
	container_id?: string;
	// container: HTMLElement | string;
	datafeed: IBasicDataFeed |string | (IBasicDataFeed & IDatafeedQuotesApi);
